...
class GlobalHighScoreDatabase {
  ...
  GlobalHighScoreDatabase({ref})
      : ref = ref ?? FirebaseDatabase.instance.ref(_leaders);
  ...
  Future<List<HighScoreRecord>> get() async {
    ...
    //top 10 leaders
    final topLeaders =
        await ref.orderByChild(lengthField).limitToLast(10).get();
