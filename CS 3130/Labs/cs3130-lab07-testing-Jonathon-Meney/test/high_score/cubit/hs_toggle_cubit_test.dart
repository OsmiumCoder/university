...
void main() {
  ...
  group('toggle local/global', () {
    blocTest<HSToggleCubit, bool>('emits Global when toggled local to global',
    ...
    blocTest<HSToggleCubit, bool>('emits Local when toggled global to local',
    ...
    blocTest<HSToggleCubit, bool>('emits nothing on same same toggle',
        build: () => HSToggleCubit(HSToggleCubit.GLOBAL),
        act: (cubit) => cubit
    ...
    blocTest<HSToggleCubit, bool>('emits local global local on multi toggles',
        build: () => HSToggleCubit(HSToggleCubit.GLOBAL),
        act: (cubit) => cubit
